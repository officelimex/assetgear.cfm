...
<cfif ThisTag.ExecutionMode EQ "Start">
    ...
    <cfparam name="Attributes.TagName" type="string" default="PasswordTextBox"/> 
    ...
    <cfparam name="Attributes.Validate" type="string" default=""/><!---integer, numeric, digits, alpha, alphanum, date, email, url,length:10, maxLength:10---->
 ...
 <div class="control-group">
	...
	<input <cfif Attributes.Disabled>disabled="disabled"</cfif> type="password" id="#request.form.formid##Attributes.name#" name="#Attributes.name#" style="display:inline-block" class="#Attributes.class# #req# #vali#" value="#Attributes.value#" placeholder="#Attributes.hint#"/> 
