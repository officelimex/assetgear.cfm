...
<cfif ThisTag.ExecutionMode EQ "Start">
    ...
    <cfparam name="Attributes.TagName" type="string" default="CheckBox"/> 
 ...
 <div class="control-group">
    ...
    <cfset i=0/>
    <div class="controls" <cfif Attributes.height neq "">style="height:#Attributes.height#;overflow-y:auto;overflow-x:hidden; width:#Attributes.width#;#Attributes.style#"</cfif>>
	...
	<cfif ListFindNoCase(Attributes.selected,lv)><cfset colr="color:red;"/></cfif>
 	<label class="checkbox <cfif Attributes.Inline>inline</cfif>" style="#colr#">

		<input type="checkbox" name="#Attributes.name#" class="#Attributes.class# #req#" value="#lv#" <cfif ListFindNoCase(Attributes.selected,lv)>checked="checked"</cfif>/> #dsp#
