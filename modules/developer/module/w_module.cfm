...
<cfset devId = '__mod_c_all_module' & url.id/>
        ...
        <table width="100%">
            <tr>
                <td valign="top" width="50%">
                    ...
                    <f:TextBox name="Code" Help="Unique variable name" required value="#qM.Code#" class="span4"/> 
                    <f:TextBox name="Position" required value="#qM.Position#" validate="integer" class="span4"/>  
