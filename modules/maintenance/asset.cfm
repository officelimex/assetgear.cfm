      ...
      <div class="span2" style="position:fixed;">
        <n:Nav renderTo="#astId#">
				<n:NavItem type="header" title="Asset"/>
					<cfif (request.IsHost) || (request.IsPlanner) || (request.IsWarehouseMan)>
				...
				<n:NavItem title="Asset Browser" url="modules/maintenance/asset/browse_asset.cfm" id="browse_asset"/>
				...
				<cfif (request.IsHost) || (request.IsPlanner)>
