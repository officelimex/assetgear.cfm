...
<cfset frId = "__asset_c_failure_report#url.cid#" & url.id/>
...
<cfoutput>
    ...
    <f:Form id="#frId#new_fr" action="controllers/Asset.cfc?method=SaveAssetFailureReport" EditId="#url.id#">
					...
					<tr>
						...
						<td>
							<f:Select name="Status"
									label="Status"
									required ListValue="Open,In Progress"
		...
		<f:ButtonGroup>
				<f:Button value="Update F.R." class="btn-primary" IsSave subpageId="new_fr" ReloadURL="modules/maintenance/asset/save_failure_report.cfm"/>
			</f:ButtonGroup>
	</f:Form>
	<script>
