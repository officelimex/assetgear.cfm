...
<cfquery name="qTotal">
    SELECT 
        ...
        SUM(ManHours) SumHours, Min(DateOpened) MinDate, Max(DateOpened) MaxDate
    FROM work_order
  ...
  <tr>
    <td valign="top" width="54%" align="center">
        <table width="90%" border="0" cellpadding="0" cellspacing="0" class="head_section">
            ...
            <tr>
                <td valign="top" nowrap class="left bottom">Cost of Maintenance</td>
                <td valign="top" class="right bottom">#numberformat(qTotal.SumCost,'9,999.99')# Naira</td>
            </tr>
        </table>
    </td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl">
                    ...
                    <cfloop query="qW">
                        <tr <cfif qW.Currentrow eq qW.Recordcount> class="bottom" </cfif>>
                            ...
                            <td valign="top" class="a-right">#numberformat(qW.TotalCost,'9,999.99')#</td>
                        </tr>
                        <cfset tsum = tsum + val(qW.TotalCost)/>
                        <cfset tmh = tmh + val(qW.ManHours)/>
                    </cfloop>
                    <tr>
