        ...
        <table border="0" width="100%">
            ...
            <tr>
                <td width="50%" valign="top">
                    ...
                    <f:TextArea name="Description" label="Full Description" help="Describe what and how it happened" value="#qIR.Description#" class="span11" rows="4"/>
                </td>
                <td class="horz-div"  valign="top">
                    ...
                    <f:TextBox name="NotificationSpecify" label="Specify" required  value="#qIR.NotificationSpecify#" class="span11"/>
                </td>
           </tr>
 			<tr class="vert-div">
            ...
            <tr>
            	<td width="50%" valign="top">
                  <f:RadioBox name="IsWorkRelated" ShowLabel Label="Is this work related?" ListValue="Yes,No" selected="#qIR.IsWorkRelated#" Inline/>
                  <f:TextBox name="IfNo" label="If not why?" required  value="#qIR.IfNo#" class="span11"/>
                  ...
                  <f:TextBox name="OtherAffectedPersonel" label="Specify Others Affected" required  value="#qIR.OtherAffectedPersonel#" class="span11"/>
                </td>
            	<td class="horz-div" valign="top">
                  ...
                  <f:TextBox name="OtherAgents" label="Specify Other Agent" required  value="#qIR.OtherAgents#" class="span11"/>
              </td>
            </tr>
        	...
        	<table border="0" width="100%">
            	<tr>
                	<td width="50%" valign="top">
                  		...
                  		<f:RadioBox ShowLabel Label="Gender" name="Gender" ListValue="Male,Female " selected="#qInj.Gender#" Inline/>
                	...
                	<table width="100%">
                    	<tr>
                            <td width="25%" valign="top">
                                ...
                                <f:CheckBox name="PhysicalInvestigation" width="auto" height="auto" style="margin-left:50px !important" ListValue="Photographs,Drawings,Qeuipment manuals, Others"  selected="#qIR.PhysicalInvestigation#" delimiter="'"/>
                            </td>
                            <td width="25%" valign="top" class="horz-div">
            	...
            	<td colspan="2">
                	<table width="100%">
                    	<tr>
                            ...
                            <td width="25%" class="horz-div" valign="top">
                                <strong>REPUTATION</strong><br/>
                                <f:CheckBox name="Reputation" width="auto" height="auto" style="margin-left:0px !important" ListValue="A - No /Temporary Local Impact,B - Local Short Term Impact,C - Local Long Term Impact (manageable outcomes),D - Local Long Term Impact (unmanageable outcomes),E - International Impact"  selected="#qIR.Reputation#" delimiter="'"/>
                            </td>
                        </tr>
                    	<tr>
                            <td width="25%" valign="top">
                        	...
                        	<tr>
                            	...
                            	<td width="30%" valign="top" class="horz-div">
                                    ...
                                    <et:Table allowInput height="100%" id="incidentinvestigationteam">
                                       ...
                                       <et:Content Query="#qI_#" Columns="InvestigatorId" type="int-select" PKField="TeamId"/>
                                    </et:Table>
                                </td>
