<cfoutput>
  ...
  <cfset request.letterhead.date = "Period : #MonthAsString(dmonth)#"/>
  ...
  <cfchart format="png" scalefrom="0" seriesplacement="stacked" show3d="no" > 
