...
<cfset EXCHANGE_RATE = 154/>
<cfset HOURLY_RATE = 50/>

<cfparam name="url.m" default="10"/>
<cfparam name="url.y" default="2015"/>
...
<cfquery name="qCm">
	#application.com.WorkOrder.WORK_ORDER_SQL#
	WHERE wo.Workclassid = 3 AND wo.departmentid = 16 AND wo.UnitId = 4
	AND DateOpened >= <cfqueryparam cfsqltype="cf_sql_date" value="#ystart#"/>
    AND DateOpened <= <cfqueryparam cfsqltype="cf_sql_date" value="#endd#"/>
</cfquery>
<cfset i = 0/>
...
<cfset request.letterhead.date = "Period : #dateformat(ystart,'mmm')# - #dateformat(endd,'mmm yyyy')#"/>
    ...
    <tbody>
        <cfloop query="qWOC">
            <tr>
                ...
                <td valign="top">#qWOC.WorkOrderId#</td>
                <td valign="top">#qWOC.Asset#</td>
                <td valign="top">#qWOC.Description#</td>
                <td valign="top">#qWOC.WorkClass#</td>
                <td valign="top">
