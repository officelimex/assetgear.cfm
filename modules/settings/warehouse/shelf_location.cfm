...
--->
<cfoutput> 
<cfset shlId = '__warehouse_setting_c'/>
...
<g:Grid renderTo="#shlId#_shelf_location" url="modules/ajax/settings.cfm?cmd=getShelfLocation" commandWidth="70px" class="table-hover table-condensed">
	...
	<g:Event command="addshl">
    	<g:Window title="'New Shelf Location'" width="550px" height="70px" url="'modules/settings/warehouse/save_shelf_location.cfm'" IdFromGrid="">
        	<g:Button IsSave IsNewForm/> 
        </g:Window>
    </g:Event>
    
	<g:Event command="editshl">
    	<g:Window title="'Edit ""' + d[1] +'""' " width="550px" height="70px" url="'modules/settings/warehouse/save_shelf_location.cfm'">
        	<g:Button IsSave /> 
        </g:Window>
    </g:Event>    
