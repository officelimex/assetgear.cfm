...
CREATE TABLE `ptw_permit` (
  ...
  `HSApprovedByUserId` int unsigned DEFAULT '0' COMMENT 'HSE Supervisor',
  `HSApprovedDate` datetime DEFAULT NULL,
  ...
  `FSCloseByUserId` int unsigned DEFAULT NULL,
  `FSCloseDate` datetime DEFAULT NULL,
